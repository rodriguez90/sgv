...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-02-2019 a las 14:12:52
...
INSERT INTO `canton` (`id`, `province_id`, `name`, `type`) VALUES
(1, 1, 'ESMERALDAS', 2),
(2, 1, 'QUININDÉ', 1);
...
INSERT INTO `parroquia` (`id`, `canton_id`, `name`) VALUES
(1, 2, 'Esmeraldas'),
(2, 2, '5 de Agosto');
...
CREATE TABLE `voto` (
  ...
  `v_jr_man` int(11) NOT NULL,
  `v_jr_woman` int(11) NOT NULL,
  `vn_jr_man` int(11) NOT NULL,
  `vn_jr_woman` int(11) NOT NULL,
  `vb_jr_man` int(11) NOT NULL,
  `vb_jr_woman` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `voto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_voto_recinto_eleccion` (`recinto_eleccion_id`),
...
ALTER TABLE `voto`
  ...
  ADD CONSTRAINT `fk_voto_recinto_eleccion` FOREIGN KEY (`recinto_eleccion_id`) REFERENCES `recinto_eleccion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
