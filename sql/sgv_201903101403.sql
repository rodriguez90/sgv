...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2019 a las 14:03:05
...
INSERT INTO `junta` (`id`, `recinto_eleccion_id`, `name`, `type`) VALUES
(1, 1, 'Junta1', 1);
...
CREATE TABLE `voto` (
  ...
  `null_vote` int(11) NOT NULL,
  `blank_vote` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `voto` (`id`, `postulacion_id`, `junta_id`, `vote`, `null_vote`, `blank_vote`, `user_id`) VALUES
(2, 1, 1, 4, 4, 4, 2);
